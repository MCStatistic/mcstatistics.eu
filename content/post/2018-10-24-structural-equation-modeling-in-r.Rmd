...
In addition, the following visualization is often used when it comes to using the function `semPaths()`. There is a weighting of the edges depending on the standardized parameter estimates. 
