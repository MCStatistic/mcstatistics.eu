...
<p align="justify">Of course you do not have to plot immediately. However, you can easily extract important data from your dataset. Let's group again by continent but now we will calculate the mean of life expectancy, the total population size for each continent and the median of the GDP per continent:</p>
